/**
 * BeeSEO theme boot — reads beeseo_system_prefs_v1, sets data-theme on <html>.
 * Exposes window.__beeseoApplySystemPrefs for Settings → System tab.
 */
(function (global) {
    const LS = "beeseo_system_prefs_v1";
    ...
    global.__beeseoApplySystemPrefs = function (prefs) {
        ...
        if (prefs.language) {
            ...
            if (global.BeeSeoI18n) global.BeeSeoI18n.apply(prefs.language);
        }
        global.dispatchEvent(new CustomEvent("beeseo:system-prefs", { detail: prefs }));
    };
