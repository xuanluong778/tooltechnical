...
| Auth modal | `templates/partials/digiseo_auth_modal.html` |
| JS auth | `static/js/digiseo-nav-auth.js` |
| Theme / i18n | `templates/partials/digiseo_theme_head.html`, `static/js/digiseo-i18n.js` |
